...
interface BakedManager { userId: number; userName: string; nationality: string; titles: Array<{ country: string; season: number }>; cupsMain: Array<{ country: string; season: number; cup: string }>; cupsSec: Array<{ country: string; season: number; cup: string }> }
